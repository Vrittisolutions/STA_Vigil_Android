...
public class AlarmManagerBroadcastReceiverGPG extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		itime = 30;
		if (isPackageExisted(context, "com.vmworkbench")
				|| isPackageExisted(context, "com.vritticrm")) {
			...
			if (Intent.ACTION_BOOT_COMPLETED.equals(intent.getAction())) {
				...
				Intent igpsalarm = new Intent(context,
						com.services.GPSServiceVigil.class);
