...
public  class DmCStateFilter extends Activity {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(getApplicationContext(), DmCstnwiseActivity.class);
    ...
    private void setListener() {
        ...
        lstcsn.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent i = new Intent(DmCStateFilter.this, DmCStateStnFilter.class);
    ...
    private void initView() {
        ...
        header.setText("DM Certificate Station wise filter");
    ...
    private void updatelist() {
       ...
       // DatabaseHandler db = new DatabaseHandler(this);
        ...
        Cursor c = sql.rawQuery(
                "SELECT DISTINCT SubNetworkCode FROM DmCertificateTable WHERE NetworkCode='"
                        + network
