...
import com.adapters.WorkAssign_NW_Adapter;
...
public class WorkAssign_Networks extends Activity {
    ...
    String DaysInstKey, ButtonClickKey;
    DatabaseHandler db;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        parent = WorkAssign_Networks.this;

        Intent intent = getIntent();
        ButtonClickKey = intent.getStringExtra("ButtonClickKey");
    ...
    public void init(){
        ...
        tvheader.setText("Work Plan Networks ");
    ...
    public void setListeners(){
        ...
        lstcsn.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(ButtonClickKey.equalsIgnoreCase("StationWiseWorkPlan")){
                    //go to stations list
                    Intent intent = new Intent(getApplicationContext(), WorkPlanAllStationsList.class);
                    intent.putExtra("Type",Type);
                    intent.putExtra("ButtonClickKey", ButtonClickKey);
                    startActivity(intent);

                }else if(ButtonClickKey.equalsIgnoreCase("SOWiseWorkPlan")){
                    //go to supporters list new activity
    ...
    private void updatelist() {
       ...
       lstcsn.setAdapter(new WorkAssign_NW_Adapter(WorkAssign_Networks.this, searchResults));
    }
    ...
    protected void showD(String string) {
        ...
        final Dialog myDialog = new Dialog(WorkAssign_Networks.this);
