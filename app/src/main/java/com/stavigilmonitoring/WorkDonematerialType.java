...
public class WorkDonematerialType extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.stavigilmonitoring.R.layout.activity_material_list);
		Intent intent = getIntent();

		searchResults = new ArrayList<MaterialListBean>();
		lstcsn =  findViewById(com.stavigilmonitoring.R.id.materialreq_list);
		...
		lstcsn.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				intent.putExtra("MaterialName", searchResults.get(position)
						.getItemdesc());
				intent.putExtra("MaterialID", searchResults.get(position)
						.getItemmasterid());
	...
	public void editActivity(String s) {
		...
		Cursor c2 = sqldb.rawQuery(
				"SELECT * FROM MaterialReqList where itemdesc=? ", params);
		String itemdesc = "";
	...
	protected void showD(String string) {
		...
		final Dialog myDialog = new Dialog(WorkDonematerialType.this);
	...
	//	DatabaseHandler db = new DatabaseHandler(this);
		...
		selectDeliveryListAdapter = new SelectDeliveryListAdapter(
				WorkDonematerialType.this, searchResults);
