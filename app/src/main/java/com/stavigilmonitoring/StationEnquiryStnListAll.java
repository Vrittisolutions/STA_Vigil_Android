...
public class StationEnquiryStnListAll extends Activity {
...
protected void onCreate(Bundle savedInstanceState) {
	...
	mImage.setOnClickListener(new OnClickListener() {
		...
		public void onClick(View v) {
			...
			if (ut.isnet(getApplicationContext())) {
				...
				try{
					ut.showD(StationEnquiryStnListAll.this, "nonet");
				}catch (Exception e){
					e.printStackTrace();
				}
			}
	...
	mListView.setOnItemClickListener(new OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> parent, View view,
			...
			dataBundle.putString("stnname", searchResults.get(position)
					.getStatioName());
			dataBundle.putString("stninst", searchResults.get(position)
					.getInstallationId());
			dataBundle.putString("Type",mType);
			dataBundle.putString("Network",mType);
			//Network
	...
	private void updatelist() {
		...
		StationAdaptor = new StationEnquiryStnAdap(
				StationEnquiryStnListAll.this, searchResults);
		...
		protected void onPostExecute(String result) {
			...
			try {
				if (sop.equals("valid")) {
					...
					try{
						ut.showD(StationEnquiryStnListAll.this, "invalid");
					}catch (Exception e){
						e.printStackTrace();
					}
				}
