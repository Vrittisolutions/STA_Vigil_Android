...
import com.adapters.AdvFrstPlayRprtStationsAdapter;
...
public class AdvFirstPlayRprt_StationsList extends Activity {
    private Context parent;

    TextView hdrnetwrks;
    ListView lst1playrprtstn;
    ImageView mRefresh;
    ...
    AdvFrstPlayRprtStationsAdapter advAdapter;
    String sop;
    ...
    public void init(){
        parent = AdvFirstPlayRprt_StationsList.this;
        ...
        mRefresh.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ut.isnet(getApplicationContext())) {
                    ...
                    ut.showD(AdvFirstPlayRprt_StationsList.this, "nonet");
                }
            }
        });
            ...
            /*lst1playrprtstn.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    if(intntFrom.equalsIgnoreCase("FirstPlayReportTab")){
                        //display first play report details
                       // lst1playrprtstn.setClickable(false);
                    }else if(intntFrom.equalsIgnoreCase("TimingDetailsReportTab")) {
                        //display timing details
                      //  lst1playrprtstn.setClickable(true);

                        EditBox_Date(Network, InstallationName, ClipNo);
    ...
    protected void EditBox_Date(final String NetworkCode, final String Stationname, final String ClipNo) {
        // TODO Auto-generated method stub

        final Dialog myDialog = new Dialog(AdvFirstPlayRprt_StationsList.this);
        ...
        final Button btn = (Button) myDialog .findViewById(com.stavigilmonitoring.R.id.gotodcliptls);
                ...
                try {
                    ...
                    if (responsemsg.contains("<InstalationId>")) {
                        ...
                        for (int i = 0; i < nl1.getLength(); i++) {
                            ...
                            if(Remarks.contains("CRC Value Clip length MISMATCH")){
                                Remarks = "Clip length MISMATCH";
                            }else {
                            ...
                            String[] formatteddate = PlayTimeFrom.split("T"); //2019-05-31  08:10:33+05:30
                            String[] formatTime = formatteddate[1].split("\\+");  //08:10:33

                            String ScheduleDate = dateconvert(formatteddate[0]);
                            String SchedTime =formatTime[0];

                            String frstplay_data[] = FirstTimePlay.split(" ");
                            Date = dateconvert_1(frstplay_data[0]);
                            Time = frstplay_data[1];
                            AmPm = frstplay_data[2];
                           ...
                           // advitem.SetNetworkCode(NW_CodeName);
                            ...
                            advitem.setDownloaded(IsDownload);
                            advitem.setRemark(Remarks);
                            advitem.setSchedule_time_date(ScheduleDate + " , " +SchedTime);
                            advitem.setFirstPlayTime(Date + " , " + Time + " " + AmPm);

                            advitem.setSchedule_date(Date);
                            advitem.setScheduleTime(Time);
                            advitem.setAmPm(AmPm);
                            //advitem.setDdate(date1);
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                if (sop.equals("valid")) {
                    ...
                    advAdapter = new AdvFrstPlayRprtStationsAdapter(parent, listStations);
                    lst1playrprtstn.setAdapter(advAdapter);

                } else if(sop.equals("invalid")){
                    Toast.makeText(parent,"No data present",Toast.LENGTH_SHORT).show();
