...
public class TvStatusMainAll extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.stavigilmonitoring.R.layout.tvstatusmain);
		...
		title.setText("TV Status - "+ Type);
		CallFrom = intent.getStringExtra("CallFrom");

		DBInterface dbi = new DBInterface(TvStatusMainAll.this);
		mobno = dbi.GetPhno();

		db = new DatabaseHandler(TvStatusMainAll.this);
		...
		if (dbvalue()) {
			updatelist();
			// fetchdata();
		} else if (ut.isnet(TvStatusMainAll.this)) {
			fetchdata();
		} else {
			ut.showD(TvStatusMainAll.this,"nonet");
		}
		...
		iv.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (ut.isnet(TvStatusMainAll.this)) {
			...
			sound.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> a, View v, int position,
					...
					*//*
					...
					final BottomSheetDialog btmsheetdialog = new BottomSheetDialog(TvStatusMainAll.this);
					...
					edt_btmsht_reasonname.setOnClickListener(new OnClickListener() {
						...
						public void onClick(View view) {
							...
							if(TvStatusMainAll.this.getCurrentFocus() != null)
							{
								imm.hideSoftInputFromWindow(TvStatusMainAll.this.getCurrentFocus().getWindowToken(), 0);
							}else {
								//Toast.makeText(SelectMenu.this,"Token is null",Toast.LENGTH_SHORT).show();
							}

							Intent intent = new Intent(TvStatusMainAll.this,TvStatusReasonList.class);
					...
					btn_tvstatressave.setOnClickListener(new OnClickListener() {
						...
						public void onClick(View view) {
							...
							progressdialogupdateserver = ProgressDialog.show(
									TvStatusMainAll.this, "Update Reason.......",
	...
	private void updatelist() {
		...
		if(searchResults.isEmpty()){
			ut.showD(TvStatusMainAll.this,"nodata");
		}else {
			listAdapter = new TvStatusMainAdpt(TvStatusMainAll.this, searchResults);
...
//+ Type + "'
		...
		if (c1.getCount() != 0) {
			...
			Cursor c = sql.rawQuery("Select distinct c1.InstallationId,c2.InstallationDesc,c1.TVStatus,c1.TVStatusReason,c1.flg from TvStatus c1  inner join ConnectionStatusFilter c2  on c1.InstallationId=c2.InstalationId where c2.NetworkCode='"
									+ Type + "'ORDER BY c2.InstallationDesc ", null);

			// Cursor c =
			// sql.rawQuery("select distinct A from TvStatus where N="+Type+"",
			// null);
			...
			if(c.getCount() != 0){
				...
				do {
					...
					if (!s.trim().equalsIgnoreCase("")&& flag!=0) {
		...
		protected void onPostExecute(String result) {
			...
			try {
				...
				if (sop.equals("valid")) {
					...
					ut.showD(TvStatusMainAll.this,"invalid");
				}
	...
	/*protected void showD(String string) {
		...
		final Dialog myDialog = new Dialog(TvStatusMain.this);
	...
	protected void onResume() {
		super.onResume();
		SharedPreferences preferences = TvStatusMainAll.this
