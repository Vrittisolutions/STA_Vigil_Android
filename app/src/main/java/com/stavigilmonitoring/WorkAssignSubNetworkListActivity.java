...
public  class WorkAssignSubNetworkListActivity extends Activity {
    ...
    private void setListener() {
        ...
        lstcsn.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent i = new Intent(WorkAssignSubNetworkListActivity.this,
    ...
    public class DmCRefresh extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            // TODO Auto-generated method stub
            super.onPreExecute();
            progressDialog = new ProgressDialog(WorkAssignSubNetworkListActivity.this);
        ...
        protected void onPostExecute(String result) {
            ...
            try{
                ...
                if(sop.equals("valid")){
                    ...
                    ut.showD(WorkAssignSubNetworkListActivity.this, "invalid");
                }
    ...
    private void initView() {
        parent = WorkAssignSubNetworkListActivity.this;
        ...
        header.setText("Activity Station wise");
    ...
    private void updatelist() {
       ...
       // DatabaseHandler db = new DatabaseHandler(this);
        ...
        Cursor c = sql.rawQuery(
                "SELECT DISTINCT SubNetworkCode FROM WorkAssignedTable WHERE NetworkCode='"
                        + network
