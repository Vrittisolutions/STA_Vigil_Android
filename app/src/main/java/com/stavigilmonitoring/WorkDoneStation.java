...
import com.adapters.WorkDoneStationAdaptor;
...
public class WorkDoneStation extends Activity {
	...
	private com.adapters.WorkDoneStationAdaptor WorkDoneStationAdaptor;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.stavigilmonitoring.R.layout.workdonestation);

		mTextview = (TextView) findViewById(com.stavigilmonitoring.R.id.edfitertext_search);
		mImageFilter = (ImageView) findViewById(com.stavigilmonitoring.R.id.button_work_filter);
		mImage = (ImageView) findViewById(com.stavigilmonitoring.R.id.button_refresh_work_Done);
		mProgress = (ProgressBar) findViewById(com.stavigilmonitoring.R.id.progressBarworkdone);
		mListView = findViewById(com.stavigilmonitoring.R.id.listStation);
		...
		mImageFilter.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (mTextview.getVisibility() == View.VISIBLE) {
					...
					imm.showSoftInput(mTextview, InputMethodManager.SHOW_IMPLICIT);
				}
		...
		mImage.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (ut.isnet(getApplicationContext())) {
					...
					ut.showD(WorkDoneStation.this, "nonet");
				}
		...
		mListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent i = new Intent(getApplicationContext(), WorkDoneFillDetail.class);
		...
		mTextview.addTextChangedListener(new TextWatcher() {
			...
			public void afterTextChanged(Editable s) {
				...
				WorkDoneStationAdaptor.filter((filter)
	...
	private void fetchdata() {
		...
		if (mDownloadStation == null) {
			...
			mDownloadStation.executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
		} else {
	...
	//	DatabaseHandler db = new DatabaseHandler(this);
		...
		WorkDoneStationAdaptor = new WorkDoneStationAdaptor(
				WorkDoneStation.this, searchResults);
		mListView.setAdapter(WorkDoneStationAdaptor);
		...
		protected void onPostExecute(String result) {
			...
			try {
				if (sop.equals("valid")) {
					...
					ut.showD(WorkDoneStation.this, "invalid");
				}
				mImage.setVisibility(View.VISIBLE);
				mProgress.setVisibility(View.GONE);
