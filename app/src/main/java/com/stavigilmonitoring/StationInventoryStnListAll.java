...
public class StationInventoryStnListAll extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		((TextView) findViewById(com.stavigilmonitoring.R.id.stationInvent)).setText("Station Inventory - " + mType);
		...
		mListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				//Intent intent = new Intent(getApplicationContext(),StationInventoryItemList.class);
		...
		ivRefresh.setOnClickListener(new  OnClickListener() {
			...
			public void onClick(View v) {
				...
				if( ut.isnet(getApplicationContext())){
					...
					try{
						ut.showD(StationInventoryStnListAll.this, "nonet");
					}catch (Exception e){
						e.printStackTrace();
					}
				}
	...
	//DatabaseHandler db = new DatabaseHandler(this);
		...
		StationAdaptor = new StationEnquiryStnAdap(StationInventoryStnListAll.this, searchResults);
		...
		protected void onPostExecute(String result) {
			...
			try {
				if (sop.equals("valid")) {
					...
					try{
						ut.showD(StationInventoryStnListAll.this, "invalid");
					}catch (Exception e){
						e.printStackTrace();
					}
				}
