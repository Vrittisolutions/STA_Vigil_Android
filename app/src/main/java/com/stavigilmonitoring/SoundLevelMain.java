...
public class SoundLevelMain extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.soundlevelmainlist);

		sound = (ListView) findViewById(R.id.soundlevelmainlist);
		iv = (ImageView) findViewById(R.id.button_refresh_sound);
		...
		title.setText(subType + "-Sound Level");
		...
		if (dbvalue()) {
			...
			try{
				ut.showD(SoundLevelMain.this, "nonet");
			}catch (Exception e){
				e.printStackTrace();
			}
		}
		...
		sound.setOnItemClickListener(new OnItemClickListener() {
			...
			//	if (dbvalue()) {
					...
					/*if (soundlevelBeanslist.get(position)
						...
						dataBundle.putString("stnname", soundlevelBeanslist.get(position).getStationname());
						dataBundle.putString("SubType", subType);
						dataBundle.putString("Installation",soundlevelBeanslist.get(position).getInstalationid());
	...
	public void getDetail() {
		...
		Cursor c = sql
				.rawQuery(
						"Select  DISTINCT s.InstallationDesc , s.CallibrationDate, s.AO , s.InstalationId ,s.ServerTime from SoundLevel_new s WHERE s.SubNetworkCode='"
		...
		soundlevelAdapter = new SoundlevelAdapter(getApplicationContext(), soundlevelBeanslist);
		...
		protected String doInBackground(String... params) {
			...
			try {
				...
				if (responsemsg.contains("<InstalationId>")) {
					...
					Log.e("SoundLevel_new node...", " fetch data : " + nl);
					String msg = "";
		...
		protected void onPostExecute(String result) {
			...
			try {
				...
				if (sop.equals("valid")) {
					...
					try{
						ut.showD(SoundLevelMain.this, "invalid");
					}catch (Exception e){
						e.printStackTrace();
					}
				}
