...
public class StationEnquiryStatewise extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.stavigilmonitoring.R.layout.stationenquirystatewise);
		...
		mRefresh.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (ut.isnet(getApplicationContext())) {
					...
					try{
						ut.showD(StationEnquiryStatewise.this, "nonet");
					}catch (Exception e){
						e.printStackTrace();
					}
				}
		...
		mList.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				if (value) {
					Intent i = new Intent(getApplicationContext(), StationEnquiryStateFilter.class);
	...
	StationEnquiryAdptr adp = new StationEnquiryAdptr(StationEnquiryStatewise.this, mSearchlist,"Default");
		...
		protected void onPostExecute(String result) {
			...
			try {
				if (sop.equals("valid")) {
					...
					try{
						ut.showD(StationEnquiryStatewise.this, "invalid");
					}catch (Exception e){
						e.printStackTrace();
					}
				}
