...
import com.adapters.SupporterMaterialDispalyAdapter;
...
public class SupporterMaterialDisplay extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		HeaderText.setText("Material Data -"+SupporterName);
	...
	private void updatelist() {
		...
		SubnetList.setAdapter(new SupporterMaterialDispalyAdapter(this, searchResult));
	...
	private ArrayList<UserList> GetDetail() {
		...
		if (c1.getCount() == 0) {
			...
			do {
				...
				String mobile, Material,Station,Installation, Remarks, currentDate, currentLocation, latitude, longitude;
			...
			//	int WorkTypeMasterID = Integer.parseInt(WorkTypeMasterId);
				Material = c1.getString(c1.getColumnIndex("MaterialName"));
				Remarks = c1.getString(c1.getColumnIndex("remarksMaterial"));
	...
	protected void showD(String string) {
		final Dialog myDialog = new Dialog(SupporterMaterialDisplay.this);
