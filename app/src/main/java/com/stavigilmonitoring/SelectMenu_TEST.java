...
public class SelectMenu_TEST extends Activity {
    Dialog dialog;
    ...
    private LinearLayout alerts, stnNotify, dmc, llgetpass, connectinStatus, downtimeReason, downtimeanalysis, nonrepeatedAd, suspectedAd,
            ...
            Lmsconnection, PDCClipwise, Blog, materialrequest, bgplaylist, downtimereasonupdated, pwd, Advclip_1stplayrprt_sewise, stnperformance;
    ...
    private TextView status, soundcunt, alertcounts, dmccounts, NonRepStationCount,NonRepAddCount, nonreportedStatus, datess,
            ...
            PDCClipCount,PDCStatncount, LmsconnectionStatuscount;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_select_menu__test);
        ...
        SharedPreferences prefDate = getApplicationContext()
                .getSharedPreferences("MyPrefDate", Context.MODE_PRIVATE);
        ...
        SharedPreferences pref1 = getApplicationContext().getSharedPreferences(
                "MyPrefnon", Context.MODE_PRIVATE); // 0 - for private mode
        ...
        SharedPreferences prefmaterial = getApplicationContext()
                .getSharedPreferences("PrefMaterial", Context.MODE_PRIVATE);
        ...
        //////********LMS Connection Count*******/////
        SharedPreferences Prefbgplay = getApplicationContext()
                .getSharedPreferences("bgpref", Context.MODE_PRIVATE);
        ...
        /***/tvclipscnt.setText("Pending Download Clips : " +ClipCnt);
        PDCClipCount.setText(ClipCnt);
        PDCStatncount.setText("Pending Download Clips Stations : " + valuesclips);
    ...
    public void init(){
        ...
        stnperformance.setVisibility(View.GONE);
    ...
    public void setListeners(){
            ...
            public void onClick(View arg0) {
                Intent viewIntent =
                        new Intent("android.intent.action.VIEW",
                                Uri.parse("http://imedia.vritti.co/Faq.aspx"));
        ...
        stnNotify.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View arg0) {
                //Intent intent = new Intent(SelectMenu_TEST.this,NotifyMultiLevelActivity.class);
                //Intent intent = new Intent(SelectMenu_TEST.this, NotificationActivity.class);
                String devid = Common.TOKEN;
                Intent intent = new Intent(SelectMenu_TEST.this, NotificationsNewActivity.class);
        ...
        videoTuts.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                //Intent intent = new Intent(SelectMenu_TEST.this,NotifyMultiLevelActivity.class);
                Intent intent = new Intent(SelectMenu_TEST.this,VideoListActivity.class);
                startActivity(intent);
            }
        });
        ...
        personalReport.setOnClickListener(new OnClickListener() {
            ...
            @Override
            public void onClick(View arg0) {
                Intent intent = new Intent(SelectMenu_TEST.this,PersonalReortActivity.class);
                startActivity(intent);
				/*finish();
				ut.showD(SelectMenu_TEST.this,"Done");*/
            }
        });
        ...
        alerts.setOnClickListener(new OnClickListener() {
            ...
            @Override
            public void onClick(View arg0) {
                Intent intent = new Intent(SelectMenu_TEST.this,AlrtListActivity.class);
                startActivity(intent);
            }
        });
        ...
        workassign.setOnClickListener(new OnClickListener() {
			...
			//	String[] a = FileHelper.saveTextFile("","Ichalkaranji","Chetana Salunkhe","MSRTC");
				...
				String data1 = "Respected Sir, \n\t\t Please find attached PDF file of submitted station visit form for" +
						" Network -  MSRTC , Station - "+"TestMSRTC" + "\n\n\t Thanks and Regards, \n\t Chetana salunkhe \n\t Via STA Vigil";//message to send
				...
				*//*Uri path1 =  FileProvider.getUriForFile(getParent(),
				...
				if (data1 != ""){
					Toast.makeText(SelectMenu_TEST.this,"Saved to file",Toast.LENGTH_SHORT).show();
				}else{
					Toast.makeText(SelectMenu_TEST.this,"Error save file!!!",Toast.LENGTH_SHORT).show();
				}

                try
                {
					String[] eml = {"chetana.salunkhe@vritti.co.in", "sanket.shende@vritti.co.in", "hemalata.gaikwad@vritti.co.in"};
                    ...
                    SelectMenu_TEST.this.startActivity(Intent.createChooser(emailIntent,"Sending email..."));
                }
                catch (Throwable t) {
                    Toast.makeText(SelectMenu_TEST.this, "Request failed try again: " + t.toString(),Toast.LENGTH_LONG).show();
                }

		*/		Intent i = new Intent(getApplicationContext(),
                        WorkAssigncategorizeActivity.class);
                startActivity(i);
            }
        });
        ...
        stnInventory.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
				...
				/*Intent intent = new Intent(getApplicationContext(),
						StationInventoryCategory.class);*/
                startActivity(intent);
            }
        });
        ...
        pwd.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                final BottomSheetDialog btmsheetdialog = new BottomSheetDialog(SelectMenu_TEST.this);
                ...
                btmsheetedsationname.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if(SelectMenu_TEST.this.getCurrentFocus() != null)
                        {
                            imm.hideSoftInputFromWindow(SelectMenu_TEST.this.getCurrentFocus().getWindowToken(), 0);
                        }else {
                            //Toast.makeText(SelectMenu_TEST.this,"Token is null",Toast.LENGTH_SHORT).show();
                        }

                        Intent intent = new Intent(SelectMenu_TEST.this, GetpassList.class);
                ...
                btngetpwd.setOnClickListener(new OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        //Toast.makeText(SelectMenu_TEST.this,"Btn getpwd clicked",Toast.LENGTH_SHORT).show();
                        txtpass.setText("");
                        ...
                        if (isnet()) {
                            if (!station.equalsIgnoreCase("")) {
                                ...
                                Toast.makeText(SelectMenu_TEST.this, "select station name", Toast.LENGTH_LONG).show();
                            }
                        } else {
        ...
        bgplaylist.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                Intent intent = new Intent(getApplicationContext(),
                        BackgroundPlaylistStatewise.class);
                startActivity(intent);
            }
        });
        ...
        PDCClipwise.setOnClickListener (new OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                Intent intent = new Intent(getApplicationContext(),
                        ClipwisePendingClipsState.class);
                startActivity(intent);
            }
        });
        ...
        Advclip_1stplayrprt_sewise.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                //cal for new screens
                //Intent intent = new Intent(SelectMenu_TEST.this, AdvFirstPlayReport_NetworkActivity.class);
                Intent intent = new Intent(SelectMenu_TEST.this, AdvClipsReports.class);
                startActivity(intent);
            }
        });
        ...
        stnperformance.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SelectMenu_TEST.this, StationPerformance.class);
                startActivity(intent);
            }
        });
    ...
    public void timerMethod() {
		...
		//DatabaseHandler db = new DatabaseHandler(SelectMenu_TEST.this);
		String val = db.getSetting();
    ...
    protected void regservicenonGPS() {
        ...
        /*______________________________________________________________________________________________________*//*
			...
			Intent myIntent = new Intent(SelectMenu_TEST.this, AlarmManagerBroadcastReceiverGPSL.class);
    ...
    public void Settings(View v) {
		/*Intent i = new Intent(SelectMenu_TEST.this, SettingsActivity.class);
		startActivity(i);*/
        ...
        btnSave_setrfrsh.setOnClickListener(new OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(SelectMenu_TEST.this,"Your settings have been save successfully", Toast.LENGTH_LONG).show();
    ...
    public class DownloadxmlsDataURL_new extends
        ...
        public void updatelist_bg() {
            ...
            SharedPreferences pref = getApplicationContext()
                    .getSharedPreferences("bgpref", Context.MODE_PRIVATE); // bgpref
            // bgPlayCount
        ...
        protected void onPreExecute() {
            ...
            progressDialog = new ProgressDialog(SelectMenu_TEST.this);
            ...
            Animation animation = AnimationUtils.loadAnimation(SelectMenu_TEST.this,
                    R.anim.rotation);
    ...
    public class DownloadxmlsDataURL_ConneStatus extends
            AsyncTask<String, Void, String> {
        ProgressDialog progressDialog;
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                if (sop.equals("valid")) {
                    ...
                    try{
                        ut.showD(SelectMenu_TEST.this,"invalid");
                    }catch (Exception e){
                        e.printStackTrace();
                    }
                }
    ...
    public class GetStationPassword extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if(result == null || result == "" || result.equalsIgnoreCase("error")){
                Toast.makeText(SelectMenu_TEST.this,"Server not responding, Try again later.", Toast.LENGTH_SHORT).show();
                pd.dismiss();
        ...
        protected void onPreExecute() {
            // TODO Auto-generated method stub
            super.onPreExecute();
            pd = new ProgressDialog(SelectMenu_TEST.this);
...
//        Bitmap bitmap = BitmapFactory.decodeResource(mResources, R.drawable.screenshot);
    ...
    private void openGeneratedPDF(){
        ...
        if (file.exists())
        {
            ...
            {
                Toast.makeText(SelectMenu_TEST.this, "No Application available to view pdf", Toast.LENGTH_LONG).show();
            }
        }
    }
