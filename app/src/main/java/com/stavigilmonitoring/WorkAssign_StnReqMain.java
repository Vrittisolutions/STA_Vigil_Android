...
import com.adapters.WorkAssign_StnReqMainAdapter;
...
public class WorkAssign_StnReqMain extends Activity {
	...
	WorkAssign_StnReqMainAdapter materialReqMainAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		title.setText(Type + "- Work Assign Station");
		...
		lstcsn.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				SharedPreferences pref = getApplicationContext()
						.getSharedPreferences("AlertPref", Context.MODE_PRIVATE);
				...
				intent.putExtra("StatioNameID", searchResults.get(position).getInstallationId());
				intent.putExtra("StatioName", searchResults.get(position).getStatioName());
				setResult(Common.WorkAssignStn2, intent);
				finish();
			}
		});
	...
	public void editActivity(String s) {
		...
		myIntent.setClass(getApplicationContext(), WorkAssign_AssignActivity.class);
		...
		protected void onPostExecute(String result) {
			...
			try {
				if (sop.equals("valid")) {
					...
					ut.showD(WorkAssign_StnReqMain.this, "invalid");
				}
				iv.setVisibility(View.VISIBLE);
				((ProgressBar) findViewById(com.stavigilmonitoring.R.id.progressBar1))
						.setVisibility(View.GONE);
	...
	protected void showD(String string) {
		...
		final Dialog myDialog = new Dialog(WorkAssign_StnReqMain.this);
	...
	public void onBackPressed() {
		/*Intent intent = new Intent(WorkAssign_StnReqMain.this,workassignStateselectActivity.class);
	...
	private void updatelist() {
		...
		materialReqMainAdapter = new WorkAssign_StnReqMainAdapter(
				WorkAssign_StnReqMain.this, searchResults);
