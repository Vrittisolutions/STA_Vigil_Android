...
public class DowntimeReasonList extends Activity {
	ListView list;
	ImageView iv;
	TextView tvpwd;
...
((EditText)findViewById(R.id.edfitertext)).addTextChangedListener(new TextWatcher() {
	...
	protected void showD(String string) {
		...
		final Dialog myDialog = new Dialog(DowntimeReasonList.this);
...
//			sr.setRemarks("");
	...
	public class GetStation extends AsyncTask<String, Void, String> {
		...
		protected String doInBackground(String... params) {	
			...
			String result="";
			String url="http://sta.vritti.co/iMedia/STA_Android_Webservice/WdbIntMgmtNew.asmx/GetReasonDownTime_Android?Mobile="+mobno;
			...
			//	sql.execSQL(ut.getDownTimeRasonFill());
				...
				Cursor c = sql.rawQuery("SELECT *   FROM DownTimeRasonFill",
						null);
				...
				e.printStackTrace();dff = new SimpleDateFormat("HH:mm:ss");
				Ldate = dff.format(new Date());
