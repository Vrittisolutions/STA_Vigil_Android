...
public class SupporterList extends Activity {
	...
	String Type, subType, Flag, CallFrom;
	DatabaseHandler db;
	...
	protected void showD(String string) {
		final Dialog myDialog = new Dialog(SupporterList.this);
