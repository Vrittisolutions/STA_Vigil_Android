...
public class StationInventoryItemNameListActivity extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.stavigilmonitoring.R.layout.activity_itemname_list);
		Intent intent = getIntent();

		searchResults = new ArrayList<MaterialListBean>();
		lstcsn = (ListView) findViewById(com.stavigilmonitoring.R.id.materialreq_list);
		iv = (ImageView) findViewById(com.stavigilmonitoring.R.id.button_refresh_materiallist);

		db = new DatabaseHandler(getApplicationContext());

		materialreqlist_name = (TextView) findViewById(com.stavigilmonitoring.R.id.materialreqlist_name);
		materialreqlist_name.setText("Item List");
		...
		lstcsn.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				intent.putExtra("MaterialName", searchResults.get(position)
						.getItemdesc());
				intent.putExtra("MaterialID",searchResults.get(position).getItemmasterid());
				setResult(Common.InvtItemName, intent);
				finish();
			}
		});
...
final Dialog myDialog = new Dialog(StationInventoryItemNameListActivity.this);
...
selectDeliveryListAdapter = new SelectDeliveryListAdapter(
		StationInventoryItemNameListActivity.this, searchResults);
