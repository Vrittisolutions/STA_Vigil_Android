...
public class DmCSonoStnFilter extends Activity {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent i = new Intent(parent, DmCSonoFilter.class);
    ...
    private void setListener() {
        ...
        lstcsn.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent i = new Intent(DmCSonoStnFilter.this, DmCSoNoStateStnDetails.class);
    ...
    private void initView() {
        ...
        header.setText("DM Certificate SO Number wise Stations");
    ...
    private void updatelist() {
       ...
       // DatabaseHandler db = new DatabaseHandler(this);
        ...
        Cursor c = sql.rawQuery(
                "SELECT Distinct StationName FROM DmCertificateTable WHERE SoNumber='"
        ...
        if (c.getCount() > 0) {
            ...
            do {
                ...
                Cursor c1 = sql
                        .rawQuery(
                                "SELECT DMDesc,ActualEndDate FROM DmCertificateTable WHERE SoNumber='"
                                        +sonum+"' and SubNetworkCode='"
