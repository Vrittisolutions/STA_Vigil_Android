...
public class StationEnquiryAdvSchedule extends Activity {
    Context parent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        parent = StationEnquiryAdvSchedule.this;
        ...
        mText.setText("Advertisement Schedule - " + conn);
        ...
        if (ut.isnet(getApplicationContext())) {
            ...
            try{
                ut.showD(StationEnquiryAdvSchedule.this, "nonet");
            }catch (Exception e){
                e.printStackTrace();
            }
        }
    ...
    private void updatelist() {
        ...
        Cursor c = sql
                .rawQuery(
                        "SELECT ScheduleTime,AdvertisementCode,AdvertisementDesc FROM AdvDetailsTable ORDER BY ScheduleTime", null);
        ...
        if (c.getCount() == 0) {
            ...
            do {
                searchResults.add(new StnEnqAdvList(c.getString(c
                        ...
                        .getColumnIndex("ScheduleTime")), "NA"));
            } while (c.moveToNext());
        }
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                if (sop == "valid") {
                    ...
                    try{
                        ut.showD(StationEnquiryAdvSchedule.this, "nodata");
                    }catch (Exception e){
                        e.printStackTrace();
                    }
                }
