...
public class ConnectionStatusMain extends Activity {
	...
	static String Ldate;
	private String scount, Type,subType,Flag;
	private Date date;
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        parent = ConnectionStatusMain.this;
		...
		((TextView) findViewById(R.id.onactivitynamereassign)).setText(" "
				+ subType + " - Connection Status");
	...
	public void editActivity(String StationName) {
		...
		Cursor c2 = sqldb.rawQuery(
				"SELECT * FROM ConnectionStatusUser where InstallationDesc='"+params+"'",
				null);
		String stnname = "";
...
url = "http://vritti.co/iMedia/STA_Announcement/TimeTable.asmx/GetCSNStatus_Android_new?Mobile="
	...
	public int printDiff(String Sdate) {
		...
		try {
			...
			if (diffDays == 0 && diffMinutes == 0 && diffHours <= 30) {
				flag = 1;
			}
