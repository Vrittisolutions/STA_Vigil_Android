...
public class JobService_PaidLocationFusedLocationTracker1 extends JobService implements LocationListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {

    private static final String TAG1 = JobService_PaidLocationFusedLocationTracker1.class.getSimpleName();
...
/*if (Build.VERSION.SDK_INT >= 23 &&
        ...
        try {
            if (mProviderType == JobService_PaidLocationFusedLocationTracker1.GPS_PROVIDER) {
                return locationManager.getLastKnownLocation(LocationManager.GPS_PROVIDER);
            } else if (mProviderType == JobService_PaidLocationFusedLocationTracker1.NETWORK_PROVIDER) {
