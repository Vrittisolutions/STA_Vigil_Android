...
public class SyncDatacountPeriodicWork extends Worker {

    private static final String TAB = SyncDatacountPeriodicWork.class.getSimpleName();
    ...
    public SyncDatacountPeriodicWork(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public void  init(){
        ...
        getApplicationContext().registerReceiver(mHandleMessageReceiver, new IntentFilter(Config.DISPLAY_MESSAGE_ACTION));
        ...
        if (Calendar.HOUR <= 20 && Calendar.HOUR >= 6)
