...
import com.stavigilmonitoring.DmCSonoStnFilter;
import com.stavigilmonitoring.DmCsonowiseActivity;
...
public  class VideoPhotoSonoFilter extends Activity {
    ...
    private void setListener() {
        ...
        lstcsn.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent i = new Intent(VideoPhotoSonoFilter.this, VideoPhotoSonoStnFilter.class);
...
*/
    ...
    private void initView() {
        parent = VideoPhotoSonoFilter.this;
        ...
        header.setText("Photo/Video SO Number wise Supporter");
    ...
    private void updatelist() {
       ...
       // DatabaseHandler db = new DatabaseHandler(this);
        ...
        Cursor c = sql.rawQuery(
                "SELECT DISTINCT SubNetworkCode FROM VideoPhotoTable WHERE SoNumber='"
                        + sonum
        ...
        if (c.getCount() > 0) {
            ...
            do {
                ...
                Cursor c1 = sql
                        .rawQuery(
                                "SELECT StationName,ActualEndDate FROM VideoPhotoTable WHERE SoNumber='"
