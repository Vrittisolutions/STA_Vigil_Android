...
public class VideoPhotoStateStnFilter extends Activity {
    ...
    private void setListener() {
        ...
        lstcsn.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent i = new Intent(VideoPhotoStateStnFilter.this, VideoPhotoStateStnSoNoDetails.class);
                i.putExtra("Network", network);
                i.putExtra("SubNetwork", subnetwork);
                i.putExtra("Type", searchResults.get(position).GetStateName());
                i.putExtra("Activity","VideophotoStateStnFilter");
                startActivity(i);
                //finish();
            }
        });
...
*/
    ...
    private void initView() {
        parent = VideoPhotoStateStnFilter.this;
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent i = new Intent(parent, VideoPhotoStateFilter.class);
    ...
    private void updatelist() {
        ...
        Cursor c = sql.rawQuery(
                "SELECT Distinct StationName FROM VideoPhotoTable WHERE NetworkCode='"
        ...
        if (c.getCount() > 0) {
            ...
            do {
                ...
                Cursor c1 = sql
                        .rawQuery(
                                "SELECT SoNumber,ActualEndDate FROM VideoPhotoTable WHERE NetworkCode='"
                                        +network+"' and SubNetworkCode='"
