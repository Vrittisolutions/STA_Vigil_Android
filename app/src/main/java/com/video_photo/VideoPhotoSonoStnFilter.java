...
import com.stavigilmonitoring.DmCSonoFilter;
...
public class VideoPhotoSonoStnFilter extends Activity {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent i = new Intent(parent, VideoPhotoSonoFilter.class);
        i.putExtra("Type", sonum);
        startActivity(i);
        finish();
    }
    ...
    private void setListener() {
        ...
        lstcsn.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent i = new Intent(VideoPhotoSonoStnFilter.this, VideoPhotoSoNoStateStnDetails.class);
                i.putExtra("Network", sonum);
                i.putExtra("SubNetwork", subnetwork);
                i.putExtra("Type", searchResults.get(position).GetStateName());
                Log.e("Extras",sonum+", "+subnetwork+", "+searchResults.get(position).GetStateName());
                startActivity(i);
               // finish();
            }
        });
...
*/
    ...
    private void initView() {
        parent = VideoPhotoSonoStnFilter.this;
        ...
        header.setText("Photo/Video SO Number wise Stations");
    ...
    private void updatelist() {
       ...
       // DatabaseHandler db = new DatabaseHandler(this);
        ...
        Cursor c = sql.rawQuery(
                "SELECT Distinct StationName FROM VideoPhotoTable WHERE SoNumber='"
        ...
        if (c.getCount() > 0) {
            ...
            do {
                ...
                Cursor c1 = sql
                        .rawQuery(
                                "SELECT DMDesc,ActualEndDate FROM VideoPhotoTable WHERE SoNumber='"
                                        +sonum+"' and SubNetworkCode='"
