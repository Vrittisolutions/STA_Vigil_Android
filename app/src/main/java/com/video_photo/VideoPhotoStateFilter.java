...
public  class VideoPhotoStateFilter extends Activity {
    ...
    private void setListener() {
        ...
        lstcsn.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent i = new Intent(VideoPhotoStateFilter.this, VideoPhotoStateStnFilter.class);
...
*/
    ...
    private void initView() {
        parent = VideoPhotoStateFilter.this;
        ...
        header.setText("Photo/Video Station wise filter");
    ...
    private void updatelist() {
       ...
       // DatabaseHandler db = new DatabaseHandler(this);
        ...
        Cursor c = sql.rawQuery(
                "SELECT DISTINCT SubNetworkCode FROM VideoPhotoTable WHERE NetworkCode='"
                        + network
