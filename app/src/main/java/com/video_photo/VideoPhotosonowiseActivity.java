...
public class VideoPhotosonowiseActivity extends Activity {
    ...
    private void setListener() {
        ((EditText) findViewById(R.id.edfitertext))
                .addTextChangedListener(new TextWatcher() {
                    ...
                    public void afterTextChanged(Editable s) {
                        ...
                        listAdapter
                                .filter_DMDesc(((EditText) findViewById(R.id.edfitertext))
        ...
        lstcsn.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                    ...
                    Intent i = new Intent(VideoPhotosonowiseActivity.this, VideoPhotoSonoFilter.class);
...
*/
    ...
    private void updatelist() {
      ...
      //  DatabaseHandler db = new DatabaseHandler(this);
        ...
        Cursor c = sql.rawQuery(
                "SELECT DISTINCT SoNumber,DMDesc FROM VideoPhotoTable ORDER BY ActualEndDate", null);
        if (c.getCount() > 0) {
            c.moveToFirst();
            do {
                ...
                Cursor c1 = sql
                        .rawQuery(
                                "SELECT SubNetworkCode,EffectiveDate,ActualEndDate FROM VideoPhotoTable WHERE SoNumber='"
                                        + c.getString(0)
    ...
    private void initView() {
        parent = VideoPhotosonowiseActivity.this;
        ...
        header.setText("Photo/Video SO Number Wise");
