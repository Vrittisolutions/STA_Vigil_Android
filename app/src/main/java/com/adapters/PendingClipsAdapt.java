...
public class PendingClipsAdapt extends BaseAdapter {
	private static List<NonRepStateBean> searchArrayList;

	private LayoutInflater mInflater;
	Context context;
	
	public PendingClipsAdapt(Context c,List<NonRepStateBean> searchResults)
	{
		context=c;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.tvsAdCnt.setText("Pending Clips : "+searchArrayList.get(position).GetAdCnt()+"");
		}
