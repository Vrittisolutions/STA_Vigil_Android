...
public class AlertStnReqMainAdapter extends BaseAdapter {
	private ArrayList<StateList> list;
	private Context parent;
	private LayoutInflater mInflater;
	private ArrayList<StateList> arraylist;

	public AlertStnReqMainAdapter(Context parent, ArrayList<StateList> soundlevelBeanslist) {
		this.parent = parent;
...
//		arraylist.addAll(searchResults);
	...
	public View getView(final int position, View convertView,
		...
		ViewHolder holder;
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.materialitem, null);
