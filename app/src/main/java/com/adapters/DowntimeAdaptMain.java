...
public class DowntimeAdaptMain extends BaseAdapter {
	...
	public DowntimeAdaptMain(Context context1, ArrayList<String> Results) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.stnname = (TextView) convertView	.findViewById(R.id.tvReason);
