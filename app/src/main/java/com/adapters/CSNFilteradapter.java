...
import com.stavigilmonitoring.ConnectionStatusStateFilter;

public class CSNFilteradapter extends BaseAdapter{
private static List<StateListFiter> searchArrayList;

private LayoutInflater mInflater;
Context context;

public CSNFilteradapter(Context c,List<StateListFiter> data)
{
	context=c;
