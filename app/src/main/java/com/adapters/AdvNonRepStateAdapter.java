...
public class AdvNonRepStateAdapter extends BaseAdapter{
	...
	public AdvNonRepStateAdapter(Context c, List<NonRepStateBean> data) {
		context = c;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.tvsStcnt = (TextView) convertView.findViewById(com.stavigilmonitoring.R.id.tvsCnt);
			holder.tvsAdCnt = (TextView) convertView
					.findViewById(com.stavigilmonitoring.R.id.tvsAdcnt);
		...
		if (s.equalsIgnoreCase("")) {
			...
			holder.tvsAdCnt.setText("Non-Reported Stations : "
					+ searchArrayList.get(position).GetSCount() + "");
			holder.tvsStcnt.setText(searchArrayList.get(position).GetAdCnt()
					+ "");
		}
//
		return convertView;
