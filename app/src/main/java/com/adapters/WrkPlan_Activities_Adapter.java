...
public class WrkPlan_Activities_Adapter extends BaseAdapter {
    ...
    public WrkPlan_Activities_Adapter(Context c, List<StateDetailsList> data)
    {
        context=c;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        WorkAssign_ActivityDetailsAdapter.ViewHolder holder;
        ...
        //pos= position;
        if (convertView == null) {
            convertView = mInflater.inflate(com.stavigilmonitoring.R.layout.activity_wrk_plan__activities__adapter, null);
            holder = new WorkAssign_ActivityDetailsAdapter.ViewHolder();
            ...
            holder = (WorkAssign_ActivityDetailsAdapter.ViewHolder) convertView.getTag();
        }
