...
public class StationEnquirySoundAdp extends BaseAdapter {
	...
	public StationEnquirySoundAdp(Context parent,
...
//		arraylist.addAll(searchResults);
	...
	public View getView(final int position, View convertView,
		...
		ViewHolder holder;
		if (convertView == null) {
			convertView = mInflater.inflate(com.stavigilmonitoring.R.layout.soundlevemainitem, null);
			...
			holder.txtcalibrationdate = (TextView) convertView
					.findViewById(com.stavigilmonitoring.R.id.txtlastcalibrationtime);
			holder.txtcalibrationvalue = (TextView) convertView
					.findViewById(com.stavigilmonitoring.R.id.txtlastfivecalibration);
			holder.txtconnectiondate = (TextView) convertView
					.findViewById(com.stavigilmonitoring.R.id.txtlastconnectiondatetime);
