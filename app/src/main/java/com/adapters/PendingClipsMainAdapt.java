...
public class PendingClipsMainAdapt extends BaseAdapter {
	private static List<PendingStateList> searchArrayList;

	private LayoutInflater mInflater;
	Context context;
	private ArrayList<PendingStateList> arraylist;
	public PendingClipsMainAdapt(Context c,List<PendingStateList> searchResults)
	{
		context=c;
...
public void filter(String charText) {
		...
		{
			for (PendingStateList wp : arraylist)
			{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		ViewHolder holder;
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.pendingclipsmainitem, null);
			...
			holder.textservertime = (TextView) convertView.findViewById(R.id.textservertime);
		...
		System.out.println("Time in adpt "+searchArrayList.get(position).getServerTime());
