...
public class BackgroundPlayStateAdp extends BaseAdapter {
	...
	public BackgroundPlayStateAdp(Context c,List<StatelevelList> data)
	{
		context=c;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.tvsName.setText(searchArrayList.get(position).getNetworkcode());
