...
public class SEActivityHistoryAdapter extends BaseAdapter {
	private static List<StateDetailsList> searchArrayList;
	private ArrayList<StateDetailsList> arraylist;
	private LayoutInflater mInflater;
	Context context;

	public SEActivityHistoryAdapter(Context c, List<StateDetailsList> data)
	{
		context=c;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		//pos= position;
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.custom_activity_row_se, null);
