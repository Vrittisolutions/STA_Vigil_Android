...
public class StationEnquirySoundDataAdp extends BaseAdapter {
	...
	public StationEnquirySoundDataAdp(Context context1, List<SoundLevelBeanSort> results) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		ViewHolder holder;
		if (convertView == null) {
			convertView = mInflater.inflate(com.stavigilmonitoring.R.layout.soundleveldupdated, null);
			holder = new ViewHolder();

			holder.ScheduleDate = (TextView) convertView
					.findViewById(com.stavigilmonitoring.R.id.tvsounddate);
			holder.ScheduleTime = (TextView) convertView
					.findViewById(com.stavigilmonitoring.R.id.txtsoundtime);
			//

			// holder.AO = (TextView) convertView
			// .findViewById(R.id.tvsoundaudio);
			holder.Standard = (TextView) convertView
					.findViewById(com.stavigilmonitoring.R.id.tvsoundstd);
			holder.Actual = (TextView) convertView
					.findViewById(com.stavigilmonitoring.R.id.tvsoundactual);
			holder.Percentage = (TextView) convertView
					.findViewById(com.stavigilmonitoring.R.id.tvsoundpercentage);
