...
public class MaterialReqAckBean {
	String pkmaterialid, materialname, reason, qty, stationname,
			stationmasterid, reason1, scraprepair, reporteename, reportingid,
			qty1, addedtdt, addedby, statusflag,senderMobNo,dispatchedorder,rejectedorder, Warranty, SelectedDt;

	public String getWarranty() {	return Warranty;}

	public void setWarranty(String warranty) {	Warranty = warranty;	}

	public String getSelectedDt() {	return SelectedDt;	}

	public void setSelectedDt(String selectedDt) {	SelectedDt = selectedDt;	}
